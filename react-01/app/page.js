  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.hero}><div><p className={styles.eyebrow}>Coleção 01 / 24</p><h1>Vista o seu<br /><em>agora.</em></h1></div><div className={styles.heroNote}><p>Site ficticio, utilizado apenas para fins educativos e treino na utilização de react.</p><a href="#produtos">Ver coleção <span>↓</span></a></div></section>
